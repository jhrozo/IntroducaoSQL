...
FROM Produto p INNER JOIN
     (SELECT Id FROM Produto
	  ...
	  ON Id_Produto.Id = p.Id INNER JOIN
...
--4 Listar todas as combinações entre os 5 primeiros números
SELECT * 
  FROM tabela_A CROSS JOIN Tabela_B

--5 Listar todas as combinações entre os 5 primeiros números, excluir as combinações repetidas.
SELECT a.numero, b.numero
FROM tabela_A As a JOIN tabela_B AS b
